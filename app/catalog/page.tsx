...
const catalogProducts: Product[] = [
  ...
  },
  {
    ...
    description: "Armaf Odyssey Mandarin Sky es una fragancia moderna y vibrante que combina la frescura chispeante de los cítricos con el dulzor cálido y seductor del caramelo y la haba tonka, culminando en una base amaderada y elegante.",
                    ...
                    {product.image ? (
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-32 h-40 bg-slate-700/40 rounded-lg shadow-xl transform group-hover:scale-105 transition-transform duration-300 flex flex-col items-center justify-center gap-2">
                          <p className="text-xs text-center font-semibold text-foreground/60">
